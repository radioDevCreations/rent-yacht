		...
		<div className="reservation-summary__reservation-time reservation-time">
			<div className="reservation-time__from-tile">
				<span className="reservation-time__from-day">
					{BoatifyDateOperations.getDayFromISOString(reservationState.new_ReservationData.startDate)}
				</span>
				<span className="reservation-time__from-month">
					{BoatifyDateOperations.getMonthAbbreviationFromISOString(reservationState.new_ReservationData.startDate)}
				</span>
			</div>
			...
			<span className="reservation-time__to-day">
					{BoatifyDateOperations.getDayFromISOString(reservationState.new_ReservationData.endDate)}
			</span>
			<span className="reservation-time__to-month">
				{BoatifyDateOperations.getMonthAbbreviationFromISOString(reservationState.new_ReservationData.endDate)}
			</span>
			</div>
		</div>
